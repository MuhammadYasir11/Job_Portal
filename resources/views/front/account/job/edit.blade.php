                    ...
                    <div class="card-body card-form p-4">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-4 col-md-6">
                                ...
                                <inpu value="{{ $job->company_location }}"t type="text" placeholder="company Location" id="compay_location" name="company_location" class="form-control">
                            </div>
                        </div>

                        <div class="mb-4">
                            <label for="" class="mb-2">Website</label>
                            <input value="{{ $job->company_website }}" type="text" placeholder="Website" id="comapny_website" name="company_website" class="form-control">
                        </div>
                    </div> 
